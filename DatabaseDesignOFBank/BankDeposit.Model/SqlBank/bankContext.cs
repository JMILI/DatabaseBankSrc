...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Cards>(entity =>
            {
                ...
                entity.Property(e => e.Cicid).HasColumnType("int(100)");
            ...
            modelBuilder.Entity<Depositors>(entity =>
            {
                ...
                entity.Property(e => e.Uicid).HasColumnType("int(100)");
            ...
            modelBuilder.Entity<Idcard>(entity =>
            {
                ...
                entity.Property(e => e.Icaddress)
                    .IsRequired()
                    .HasColumnName("ICaddress")
                    .HasColumnType("varchar(200)");
            ...
            modelBuilder.Entity<Records>(entity =>
            {
                ...
                entity.Property(e => e.Ricid).HasColumnType("int(200)");
                ...
                entity.HasOne(d => d.Ric)
                    .WithMany(p => p.Records)
                    .HasForeignKey(d => d.Ricid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
